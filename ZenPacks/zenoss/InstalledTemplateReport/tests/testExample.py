...
class TestExample(BaseTestCase):
    ...
    def afterSetUp(self):
        ...
        # Always call the base class's afterSetUp method first, so things like
        # self.dmd will be available.
    ...
    def beforeTearDown(self):
        ...
        # case will be rolled back, so this method is not be necessary in most
        # cases.
